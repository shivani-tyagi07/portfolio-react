      ...
      <div className='container mx-auto px-6 flex flex-col md:flex-row items-center justify-between'>
        ...
        <div className='md:w-1/2 mb-10 md:mb-0'>
          ...
          <h1 className='text-4xl md:text-6xl font-bold mb-4 text-white'>
            Hi, I'm
            <span className='text-purple'> Shivani Tyagi </span>
          </h1>
          ...
          <div className='flex space-x-4'>
            ...
            <a
              href="#projects"
              className='px-6 py-3 bg-purple text-white rounded-lg font-medium hover:bg-purple/80 transition duration-300'
            >
              View Work
            </a>
            ...
            <a
              href="#contact"
              className='px-6 py-3 border border-purple text-white rounded-lg font-medium hover:bg-purple/20 transition duration-300'
            >
              Contact Me
            </a>
